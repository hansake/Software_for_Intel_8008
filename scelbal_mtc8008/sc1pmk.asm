...
;;;
;;; Modified to run on a simulated 8008 based process monitoring
;;; computer (promoncomp) that was made as a master thesis work
;;; in 1975. The simulator is based on SIMH.
...
;        Intel 8008 Master Thesis computer (promoncomp).
;
...
;    Outport 4: used to output character to printer.
;    Inport 5: used to input character from keyboard.
;
